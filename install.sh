...
wm="bspwm sxhkd polybar kitty lxappearance feh dunst maim xclip network-manager-applet iwd xdg-utils xdg-user-dirs"

file="pcmanfm gvfs xarchiver gvfs-mtp tumbler poppler-glib ffmpegthumbnailer gnome-epub-thumbnailer unzip unrar"

apps="neofetch mpv youtube-dl discord qbittorrent neovim htop mupdf mupdf-tools pandoc imagemagick"
...
AUR="brave-bin xp-pen-tablet betterlockscreen anki-official-binary-bundle redshiftgui-bin mangohud lib32-mangohud goverlay-bin an-anime-game-launcher-bin whatsapp-nativefier heroic-games-launcher-bin spotify polymc modprobed-db"
emulator="pcsx2-git citra-qt-git"
