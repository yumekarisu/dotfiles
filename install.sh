...
x11		= "xorg-xserver xorg-xinit xorg-xsetroot"
audio		= "pipewire pipwire-pulse pipewire-alsa pipewire-jack lib32-pipewire lib32-pipewire-jack wireplumber pavucontrol"
...
wm		= "bpswm sxhkd polybar alacritty lxappearance nitrogen betterlockscreen dunst maim xclip network-manager-applet xdg-utils xdg-user-dirs"
file		= "pcmanfm gvfs xarchiver gvfs-mtp gvfs-gphoto2 gvfs-afc gvfs-smb tumbler poppler-glib ffmpegthumbnailer freetype2 libgsf evince gnome-epub-thumbnailer unzip unrar udiks"
...
cp bspwm/floating ~/.config/bspwm/floating
